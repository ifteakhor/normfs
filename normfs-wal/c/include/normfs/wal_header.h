...
enum normfs_wal_header_status {
	NORMFS_WAL_HEADER_OK = NORMFS_UINTN_VARINT_OK,
	NORMFS_WAL_HEADER_ERR_TRUNCATED = NORMFS_UINTN_VARINT_ERR_TRUNCATED,
	NORMFS_WAL_HEADER_ERR_OVERFLOW = NORMFS_UINTN_VARINT_ERR_OVERFLOW,
	NORMFS_WAL_HEADER_ERR_NON_CANONICAL = NORMFS_UINTN_VARINT_ERR_NON_CANONICAL,
	NORMFS_WAL_HEADER_ERR_NO_SPACE = NORMFS_UINTN_VARINT_ERR_NO_SPACE,
