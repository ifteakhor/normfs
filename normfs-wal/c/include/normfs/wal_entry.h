...
enum normfs_wal_entry_status {
	NORMFS_WAL_ENTRY_OK = 0,
	NORMFS_WAL_ENTRY_ERR_TRUNCATED = 1,
	NORMFS_WAL_ENTRY_ERR_OVERFLOW = 2,
	NORMFS_WAL_ENTRY_ERR_NON_CANONICAL = 3,
	NORMFS_WAL_ENTRY_ERR_NO_SPACE = 4,
